...
from Mizuharabot.modules import ALL_MODULES
from Mizuharabot.modules.helper_funcs.chat_status import is_user_admin
from Mizuharabot.modules.helper_funcs.misc import paginate_modules
from Mizuharabot.modules.sudoers import bot_sys_stats
...
PM_START_TEXT = f"""
Hello there,The name's *Mizuhara* [🧚‍♂️](https://blogger.googleusercontent.com/img/a/AVvXsEjsqRII-UIZir8h03OX-lcjs05XHaGu9XGCcDjJxyAW3xgSY_jlK3HImGlglhv6nBK1V_34FKS-mZSLU4jQTyBquIBh8dnFjZM6lVc5OMBeS7ncXPFrd4mD29t00nGHqejqGrXsYveuN5_QRbssTP1pA37SPFXlruaxyZOKGPSBHJ51vZKeZwTWQuEphA)
I am an Anime themed group management with some fun features.
Make sure you read *About Me* section below."""

buttons = [
     [
        InlineKeyboardButton(text="➕ ADD Chizuru TO YOUR GROUP ➕", url="t.me/Shinobu_robot?startgroup=true"),   
    ],
    [
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Mizuharabot.modules." + module_name)
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Heya, Mizuhara here :) PM me if you have any questions how to use me!")
...
def Mizuhara_about_callback(update, context):
    ...
    if query.data == "Mizuhara_":
        query.message.edit_text(
            text=""" My name is *Mizuhara*, I have been written with Pyrogram and Telethon.. I'm online since 10 June 2021 and is constantly updated!
*Bot Version: 3.0*
\n*Bot Developers:*
-  @dihanrandila
-  @InukaASiTH
...
* Support Chat:* @Shinobu_Support
    ...
    elif query.data == "Mizuhara_basichelp":
        query.message.edit_text(
            text=f"*Here's basic Help regarding* *How to use Me?*"
            f"\n\n• Firstly Add {dispatcher.bot.first_name} to your group by pressing [here](http://t.me/{dispatcher.bot.username}?startgroup=true)\n"
            f"\n• After adding promote me manually with full rights for faster experience.\n"
            f"\n• Than send `/admincache@chizuru_mizuhara_robot` in that chat to refresh admin list in My database.\n"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Admins 👮‍♂️", callback_data="Mizuhara_admin"),
                    InlineKeyboardButton(text="Notes 📑", callback_data="Mizuhara_notes"),
                 ],
                 [
                    InlineKeyboardButton(text="Support 👨‍🔧", callback_data="Mizuhara_support"),
                    InlineKeyboardButton(text="Credits 👨‍💻", callback_data="Mizuhara_credit"),
                 ],
                 [
    ...
    elif query.data == "Mizuhara_admin":
        query.message.edit_text(
            text=f"*Let's make your group bit effective now*"
            f"\nCongragulations, *Mizuhara* now ready to manage your group."
            f"\n\n*Admin Tools*"
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Back", callback_data="Mizuhara_basichelp")]]
            ),
        )

    elif query.data == "Mizuhara_notes":
        query.message.edit_text(
    ...
    elif query.data == "Mizuhara_support":
        query.message.edit_text(
            text="* Mizuhara's Updates News & Supports*"
    ...
    elif query.data == "Mizuhara_credit":
        query.message.edit_text(
            text=f"*Credit For Mizuhara's Devs*\n"
            f"\nHere Some Developers Helping in Making The Mizuhara Bot",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
